	      ...
	      <div className="container-fluid py-5">
	        ...
	        <div className="row">
	        	<div className="col-lg-6">
	        		<FormTodo addTodo={addTodo} onChangeForm={handleFormChange} todo={todo}></FormTodo>	
	        	</div>

	        	<div className="col-lg">
	        		<ListTodo todos={todos} onDeleteTodo={deleteTodo} onUpdateTodo={updateTodo}></ListTodo>
	        	</div>
	        </div>
